...
const testParser = async function(filePath, opath, ignoreDepends) {
  ...
  // 处理依赖
  if(!hasDeal.has(filePath) && !ignoreDepends) {
...
const main = async function() {
  ...
  // await testParser(widgetPath, widgetPath.replace(widgetBasePath, outPath), true)
